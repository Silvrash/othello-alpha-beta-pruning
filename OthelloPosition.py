...
class OthelloPosition(object):
    ...
    def make_move(self, action: OthelloAction):
        ...
        """
        current_player = 'B'
        if(self.maxPlayer == True): current_player = 'W'
        ...
        for dir in self.DIRS:
            ...
            if(capture == True):
                ...
                while(self.__is_opp_coin(action.row+dir[0]*i, action.col+dir[1]*i)):
                    ...
                    i = i+1
                    print("placing ", current_player, " on row ", action.row+dir[0]*i, "and col ", action.col+dir[1]*i)

            print(capture, "row: ",action.row, "col: ",action.col, "dir row: ", dir[0], "dir col: ", dir[1],"\n")

        if(self.maxPlayer == True):  # True = White to move, False = Black to move)
